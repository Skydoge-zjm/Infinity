...
infer_eval_image_reward() {
    ...
    # step 1, infer images
    ${python_ext} /home/wangkai/jmzhang/Infinity/evaluation/image_reward/infer4eval.py \
    --cfg ${cfg} \
    --tau ${tau} \
    --pn ${pn} \
    ...
    ${python_ext} /home/wangkai/jmzhang/Infinity/evaluation/image_reward/cal_imagereward.py \
...
infer_eval_hpsv21() {
    ...
    mkdir -p ${out_dir}
    ${python_ext} /home/wangkai/jmzhang/Infinity/evaluation/hpsv2/eval_hpsv2.py \
    --cfg ${cfg} \
    --tau ${tau} \
    --pn ${pn} \
    --model_path ${infinity_model_path} \
